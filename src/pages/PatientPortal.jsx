    ...
    const Loggedin=()=>{
        return (
            ...
            <div className="auth-card">
                <div className="auth-icon"><MedicalNotesIcon width='100px' height="100px" strokeColor='#2f44d1'/></div>
            ...
            <div className="auth-card">
                <div className="auth-icon"><UserIcon width='100px' height="100px" strokeColor='#2f44d1'/></div>
